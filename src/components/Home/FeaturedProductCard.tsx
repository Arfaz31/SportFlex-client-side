...
const FeaturedProductCard = ({ item }: { item: TInputs }) => {
  ...
  return (
    <div
      className="col-span-1 flex flex-col md:h-[380px] h-[315px] relative group bg-[#f5f5f5] hover:transition-transform md:hover:scale-105 hover:scale-100 hover:duration-500 hover:ease-in-out bg-opacity-50 w-full rounded-lg shadow-xl  px-2"
      key={item._id}
    >
