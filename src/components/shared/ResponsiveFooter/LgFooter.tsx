        ...
        <div className="grid grid-cols-12 gap-12">
            ...
            <div className="flex flex-col space-y-5">
              <div>
                ...
                <p className="text-white pt-6 xl:text-base text-xs">
                  Your Ultimate Destination for Premium Sports Gear and
                  Equipment. Shop with us for the best in quality and
                  performance.
                </p>
              </div>
          ...
          <div className="col-span-2">
            <div className="flex flex-col space-y-[12px]  text-white">
              ...
              <div className="group relative w-[120px] cursor-pointer">
                <p className="xl:pt-3 pt-2 xl:text-base text-xs">
                  Shopping Cart
                </p>
                <span className="custom-hover-line"></span>
              </div>
              <div className="group relative w-[63px] cursor-pointer">
