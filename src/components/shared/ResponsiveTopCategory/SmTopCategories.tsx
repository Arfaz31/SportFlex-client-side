...
const SmTopCategories = () => {
  ...
  for (let i = 0; i < categoriesData.length; i += 1) {
    slides.push(categoriesData.slice(i, i + 1));
  }
  return (
    <div className="my-24">
      <h1 className="text-2xl font-bold text-center mb-10">TOP CATEGORIES</h1>
      <div>
        <Container>
          <Carousel
...
export default SmTopCategories;
