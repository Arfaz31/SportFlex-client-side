          ...
          <Tabs defaultValue="shoes" className="w-full">
            ...
            <TabsContent value="shoes">
              <div className="grid  md:grid-cols-3 md:gap-5 grid-cols-2 gap-4 xl:px-0 px-2  ">
                {shoesData.map((item) => (
                  <div
                    className="col-span-1 flex flex-col md:h-[360px] h-[300px] relative group  bg-[#f5f5f5] hover:transition-transform md:hover:scale-105 hover:scale-100 hover:duration-500 hover:ease-in-out  bg-opacity-50  w-full rounded-lg shadow-xl hover:border-2 hover:border-[rgb(0,205,229)]"
                    key={item.id}
                  >
